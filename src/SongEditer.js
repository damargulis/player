...
export default class SongEditer extends React.Component {
  ...
  render() {
    ...
    const genres = this.props.library.getGenresByIds(track.genreIds).join(', ');
    return (
      <div>
          <h3 className="title">Edit Track{this.props.tracks.length > 1 ? 's' : ''}</h3>
          <div className="edit-container">
            <label className="label" >Name: </label>
            <input ref={this.name} defaultValue={track.name} className="input" placeholder="Name"/>
          </div>
          <div className="edit-container">
            <label className="label" >Artists: </label>
            <input defaultValue={artists} className="input" placeholder="Artists"/>
          </div>
          <div className="edit-container">
          ...
          <div className="edit-container">
            ...
            <input className="input" defaultValue={genres} />
          </div>
          <div className="edit-container">
          ...
          <div className="edit-container">
            ...
            <input className="input" defaultValue={track.playCount} type="number" />
          </div>
